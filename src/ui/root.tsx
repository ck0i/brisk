...
function Conversation(props: {
  ...
  const syntaxStyle = SyntaxStyle.fromStyles({
    ...
    "markup.heading.3": { fg: COLORS.accent, bold: true },
    "markup.heading.4": { fg: COLORS.accent, bold: true },
    "markup.heading.5": { fg: COLORS.accent, bold: true },
    "markup.heading.6": { fg: COLORS.accent, bold: true },
    "markup.strong": { fg: COLORS.text, bold: true },
    "markup.italic": { fg: COLORS.text, italic: true },
    "markup.strikethrough": { fg: COLORS.text, dim: true },
    "markup.raw": { fg: "#a5d6ff" },
    "markup.raw.block": { fg: "#a5d6ff" },
    "markup.link": { fg: COLORS.accent },
    "markup.link.label": { fg: COLORS.accent, underline: true },
    "markup.link.url": { fg: COLORS.muted, underline: true },
    "markup.link.bracket.close": { fg: COLORS.accent },
    "markup.list": { fg: COLORS.accent },
    "markup.list.unchecked": { fg: COLORS.accent },
    "markup.list.checked": { fg: COLORS.success },
    "markup.quote": { fg: COLORS.muted, italic: true },
    "keyword.directive": { fg: COLORS.warning, bold: true },
    "punctuation.special": { fg: COLORS.accent },
    "string.escape": { fg: COLORS.warning },
    "character.special": { fg: COLORS.warning },
